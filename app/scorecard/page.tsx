...
const SCHEMA: MetricDef[] = [
  ...
  { type:'input',  id:'ellow_dms',       inputId:'ellow_dms',       label:'DMs Sent',         targets:{d:80,  w:560} },
  ...
  { type:'input',  id:'edv_booked',  inputId:'edv_booked',  label:'Booked',            targets:{d:2,  w:12} },
  ...
  { type:'input',  id:'atl_booked',  inputId:'atl_booked',  label:'Booked',            targets:{d:2,  w:12} },
  ...
  { type:'calc',   id:'team_booked', label:'Total Booked',          targets:{d:6,   w:38}  },
